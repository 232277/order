...
public abstract class AbstractUVCCameraHandler extends Handler {
    ...
    public interface OnPreViewResultListener {
        default void onPreviewResult(byte[] data){}
        default void onPreviewResult(ByteBuffer frame){}
    }
...
//	}
    ...
    public void startPreview(final Object surface) {
        ...
        if (!((surface instanceof SurfaceHolder) || (surface instanceof Surface) || (surface instanceof SurfaceTexture))) {
            Log.e(TAG, "startPreview: surface should be one of SurfaceHolder, Surface or SurfaceTexture: " + surface);
            return;
...
//		}
        ...
        public void handleClose() {
            ...
            if (camera != null) {
                //丁语成 2020年4月29日14:15:48 添加log
                Log.e(TAG, "handleClose: do close");
                camera.stopPreview();
                camera.destroy();
                callOnClose();
            }
...
//				}
                //丁语成 2020年4月28日10:48:30 ADD
                if (mPreviewListener != null){
                    mPreviewListener.onPreviewResult(frame);
                }

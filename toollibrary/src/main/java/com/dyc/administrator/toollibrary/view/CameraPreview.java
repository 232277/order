...
public class CameraPreview extends TextureView {
	...
	private OnSavedPicListener onSavedPicListener;
	...
	public CameraPreview(Context context, AttributeSet attrs) {
		...
		mFile = new File(getContext().getExternalFilesDir(null), "pic"
				+ new Date(System.currentTimeMillis()) + ".jpg");
	}
	...
	public void setOnSavedPicListener(OnSavedPicListener onSavedPicListener) {
		this.onSavedPicListener = onSavedPicListener;
	}
...
//					CaptureRequest.CONTROL_AE_PRECAPTURE_TRIGGER_START);
	...
	private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
		...
		public void onImageAvailable(ImageReader reader) {
			mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), mFile,
					file -> {
						if (onSavedPicListener != null){
							onSavedPicListener.onSaved(file);
						}
					}));
		}
	};
	...
	private static class ImageSaver implements Runnable {
		...
		private OnSavedPicListener listener;

		ImageSaver(Image image, File file, OnSavedPicListener listener) {
			mImage = image;
			mFile = file;
	...
	public interface OnSavedPicListener{

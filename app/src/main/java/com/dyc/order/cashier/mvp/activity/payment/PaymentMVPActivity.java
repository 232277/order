...
/**
 * func:
 * author:丁语成 on 2020/3/20 10:54
 * mail:dingyucheng@centerm.com
 * tel:18279114677
 */
public class PaymentMVPActivity extends
		BaseOutScanActivity<
                PaymentActivityContact.PaymentActivityModel,
						PaymentActivityContact.PaymentActivityView,
						PaymentActivityContact.PaymentActivityPresent>
		implements PaymentActivityContact.PaymentActivityView, View.OnClickListener {
...
//				showToast(R.string.tip_in_develop);
	...
	protected void onDestroy() {
		super.onDestroy();
		DataCache.removeData(ActivityOperationField.PAYMENT_REQUEST);
	}
}

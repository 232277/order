...
public class AddMemberByCodeActivity extends BaseCountDownActivity<
		...
		if (TextUtils.isEmpty(identifier)) {
			...
			if (!memberInfoData.isIdentified() && memberInfoData.getNew() != null && memberInfoData.getNew()){
				...
				timer.schedule(new TimerTask() {
					@Override
					public void run() {
						startActivity(new Intent(AddMemberByCodeActivity.this, FaceCaptureByUvcActivity.class));
						finish();
					}
				}, 1000);
			}
